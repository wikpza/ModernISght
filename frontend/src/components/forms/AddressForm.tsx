...
const AddressForm = ({onSave, setOpen,type="POST", address=
    {
        firstName:'',
        lastName:"",
        addressLine1:"",
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className={'rounded-lg md:p-5 space-y-4 text-gray-700 '}>
                ...
                <CustomInput name={'addressLine1'} label={'Street address'} form={form}/>
                <CustomInput name={'addressLine2'} label={'Apartment, suite, etc. (optional)'} form={form}/>


                <div className={'flex flex-row space-x-3'}>
                    <CustomInput name={'city'} label={'City'} form={form}/>
                    <CustomInput name={'state'} label={'State'} form={form}/>
                    <CustomInput name={'zipCode'} label={'Zip code'} form={form}/>
                </div>
                ...
                <div className={'flex flex-row items-center text-sm space-x-2 font-medium pt-5'}>
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem >
                                <FormControl>
                                    <Checkbox className={'border-gray-400'} value = {form.getValues('preferred')} checked ={form.getValues('preferred')}
