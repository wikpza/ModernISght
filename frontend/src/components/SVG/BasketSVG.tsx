const BasketSVG = ({className}:{className:string}) => {
    return (

        <svg className={className}
            width="24px" height="24px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
             fill={'none'}
        >
            ...
            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" >
                <g id="Icon-Set"  transform="translate(-516.000000, -723.000000)"
                   fill="#000000">
                    <path
