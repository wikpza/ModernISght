...
import {useUpdateCategory} from "../../../../../api/CategoryApi.tsx";
...
export default ({category}:Props) => {
    ...
    const {isLoading, updateCategory, isSuccess} = useUpdateCategory()
                ...
                <Dialog.Overlay className="DialogOverlay" style={{zIndex:"1000"}} >
                    ...
                    <Dialog.Content className="DialogContent rounded sm:rounded-t rounded-t-3xl w-full">
                        <DialogHeader>
                            ...
                            <CategoryForm  setOpen={setOpen} category={category} onSave={updateCategory} type={"PATCH"} />
