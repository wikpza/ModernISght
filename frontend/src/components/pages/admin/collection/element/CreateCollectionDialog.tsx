...
import {useCreateCollection} from "../../../../../api/CollectionApi.tsx";
...
export default () => {
    ...
    const {createCollection, isLoading, isSuccess} = useCreateCollection()
                ...
                <Dialog.Overlay className="DialogOverlay">
                    <Dialog.Content className="DialogContent rounded sm:rounded-t rounded-t-3xl w-full ">
                        <DialogHeader>
                            ...
                            <CollectionForm onSave={createCollection} isLoading={isLoading} setOpen={setOpen}/>
