...
const CardBankItem = ({ cvv, cardNumber, expiryDate, cardId }: Props) => {
    ...
    return (
        <div className={'max-w-[400px] w-full flex-1 relative'}>
            <div className={'absolute top-8 right-8 z-20 bg-white p-2 rounded border-black border-2 hover:bg-gray-200 cursor-pointer'}
