...
import logo from "../../pictures/Снимок экрана 2024-12-17 в 16.26.55.png"
const Footer = () => {
    return (
        <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24 footer_back mt-20">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-[0px] h-40 rounded sm:w-auto"
                             src={logo} alt=""/>
                ...
                <p className="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by Modern Sight</p>
            </div>
        </section>
    );
};
